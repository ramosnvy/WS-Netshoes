        ...
        <div class="card-group col-4  mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text"><small class="text-muted"><?php $preco = ($produto->getPreco()); echo ("de ".$preco[0]);?></small></p>
                    <p class="card-text"><?php $preco = ($produto->getPreco()); echo ("por ".$preco[1]);?></p>
